...
public class SPARQLExecutor {
	...
	public static ResultSet executeSelect(Object dataset, String query){
		return executeSelect(dataset, toQueryObject(query));
	}
	/**
	...
	public static Model executeConstruct(Object dataset, Query query){
		...
		try{			
			...
			if(dataset == null){
				...
				String endpoint = (String)dataset;
				QueryEngineHTTP exeh = (QueryEngineHTTP) QueryExecutionFactory.sparqlService(endpoint, query);
				exeh.setModelContentType(WebContent.contentTypeNTriplesAlt);
				Model result = exeh.execConstruct();
				return result;
			}else if(dataset instanceof Dataset){
				Dataset ds = (Dataset)dataset;
				exe = QueryExecutionFactory.create(query, ds);
	...
	public static Model executeConstruct(Object dataset, String query){
		return executeConstruct(dataset, toQueryObject(query));
	}
	/**
	...
	public static boolean executeAsk(Object dataset, String query){
		return executeAsk(dataset, toQueryObject(query));
	}
	////////////////////////////////////////////////////////////////////////////////////////
	///////////////QUERY UPDATE //////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////////
